...
using mRemoteNG.UI.WindowForms;
#endregion
...
namespace mRemoteNG.UI.Forms
{
    ...
    public partial class FrmMain
    {
        ...
        {
            fileMenu.TreeWindow = WindowsApp.TreeForm;
        ...
        internal void UpdateWindowTitle()
        {
            ...
            if (!string.IsNullOrEmpty(SelectedConnection?.Name))
            {
                ...
                if (Properties.Settings.Default.TrackActiveConnectionInConnectionTree)
                    WindowsApp.TreeForm.JumpToNode(SelectedConnection);
            }
        ...
        public void SetDefaultLayout()
        {
            ...
            WindowsApp.TreeForm.Show(pnlDock, DockState.DockLeft);
            WindowsApp.ConfigForm.Show(pnlDock, DockState.DockLeft);
            WindowsApp.ErrorsForm.Show(pnlDock, DockState.DockBottomAutoHide);
