...
namespace mRemoteNG.UI.WindowForms
{
    ...
    public partial class PortScanWindow
    {
        ...
        {
            var selectedNode = WindowsApp.TreeForm.SelectedNode
                            ?? WindowsApp.TreeForm.ConnectionTree.ConnectionTreeModel.RootNodes.OfType<RootNodeInfo>()
                                      .First();
            ...
            if (selectedNode is RootPuttySessionsNodeInfo || selectedNode is PuttySessionInfo)
                selectedNode = WindowsApp.TreeForm.ConnectionTree.ConnectionTreeModel.RootNodes.OfType<RootNodeInfo>()
                                      .First();
