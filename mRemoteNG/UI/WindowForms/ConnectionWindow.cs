...
namespace mRemoteNG.UI.WindowForms
{
    ...
    public partial class ConnectionWindow : BaseWindow
    {
        ...
        private void SshTransferFile()
        {
            try
            {
                ...
                WindowsApp.SshtransferForm.Hostname = connectionInfo.Hostname;
                WindowsApp.SshtransferForm.Username = connectionInfo.Username;
                WindowsApp.SshtransferForm.Password = connectionInfo.Password;
                WindowsApp.SshtransferForm.Port = Convert.ToString(connectionInfo.Port);
            }
            catch (Exception ex)
            {
